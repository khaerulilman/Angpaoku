...
export const useDashboardStore = defineStore('dashboard', () => {
  ...
  const navItems = ref<NavItem[]>([
    ...
    { label: 'Points', icon: 'toll', route: '/dashboard/points' },
    { label: 'OBS Settings', icon: 'settings_input_component', route: '/dashboard/obs-settings' },
